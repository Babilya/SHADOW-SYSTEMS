...
• OSINT: Вимкнено | Базова аналітика
• Ідеально для новачків і тестування

<b>⭐ Standard - 300 грн/мес</b>
• Боти: 50 | Розсилок: 500/мес | Парсинг: 5,000 контактів  
• OSINT: 50 запитів | AI Sentiment: базова версія
• Підходить для малих проектів

<b>👑 Premium - 600 грн/мес</b>
• Боти: 100 | Розсилок: 5,000/мес | Парсинг: 50,000 контактів
• OSINT: 500 запитів | AI Sentiment: повна версія | Прогноз ризиків
• Для професіоналів та агенцій

<b>💎 VIP Elite - 1,200 грн/мес</b>
• Боти: Необмежено | Розсилки: Необмежено | Парсинг: Необмежено
• OSINT: Необмежено | AI: Всі функції | Пріоритетна підтримка 24/7
• Для крупних компаній і масштабу"""
