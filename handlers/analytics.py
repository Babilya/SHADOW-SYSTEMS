...
def analytics_kb():
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="✍️ Генерація тексту", callback_data="generate_text")],
        [InlineKeyboardButton(text="◀️ Назад", callback_data="back_to_menu")],
    ])

def analytics_description() -> str:
    ai_status = "🟢 Активний" if ai_service.is_available else "🟡 Базовий режим"
    return f"""<b>📊 АНАЛІТИКА & МЕТРИКИ</b>

<b>AI Статус:</b> {ai_status}

<b>📈 Звіти</b>
Детальні звіти по кампаніям: CTR, конверсія, ROI.

<b>😊 AI Sentiment</b>
Аналіз тональності повідомлень за допомогою AI.

<b>⚠️ Прогноз ризиків</b>
AI прогнозування ризику блокування.

<b>📊 Дашборд</b>
Ключові метрики в реальному часі.

<b>⏰ Найкращий час</b>
Рекомендації щодо часу розсилок.

<b>✍️ Генерація тексту</b>
AI створення текстів для кампаній."""
...
<b>💰 Фінанси:</b>
├ Витрачено: 45 кредитів
└ Залишок: 955 кредитів"""
